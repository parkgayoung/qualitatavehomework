...
if(window.s){$("body").delegate(".moduleFragment a","click",function(){var i=$("#productTitle").text(),h=$(this).text().replace(/\s+/g," ");
h=toUnicode(h);
wol.analytics.trackLink($(this),{linkTrackVars:"events",linkTrackEvents:"event8",events:"event8",eVars:{eVar3:i,eVar7:h}})
})
...
c("body").delegate(".altmetric-embed a.altmetric_details, .altmetric-embed > a img","click",function(g){a.analytics.trackLink(c(this),{linkTrackEvents:"event26",events:["event26"]})
})
}};
